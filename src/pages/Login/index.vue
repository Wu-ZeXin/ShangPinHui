						...
						<div class="content">
							<form>
								...
								<div class="input-text clearFix">
									...
									<span class="error-msg" v-if="error.showPasswordError">{{ error.showPasswordError }}</span>
								</div>
...
export default {
  ...
  methods: {
     async userLogin() {
       ...
       try{
          await this.$store.dispatch('user/getLogin',{
            phone: this.phone,
            password: this.password
          }) 
          let route = this.$route.query.redirect || '/home'
