      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            ...
            <div class="support">
              ...
              <div class="supportArea">
                ...
                <div class="fixWidth">广东省 惠州市 惠城区</div>
              </div>
            </div>
          </div>
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" :value="count" class="itxt" />
                <a href="javascript:;" class="plus" @click="count++">+</a>
                <a href="javascript:;" class="mins" @click="count > 1 ? count-- : 1">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  methods:{
    addShopCart() {
      ...
      try {
        this.$store.dispatch('detail/addShopCart',{ skuId: this.$route.params.skuId, skuNum: this.count })
        sessionStorage.setItem('skuInfo',JSON.stringify(this.skuInfo))
        this.$router.push({ name:'addshopcart', query:{ count: this.count }})
      }catch(error) {
        alert('加入购物车失败')
      }
